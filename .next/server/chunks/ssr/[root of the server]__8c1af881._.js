...
"[project]/src/app/actions/fillMissedDays.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$fillMissedDays$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions/fillMissedDays.ts [app-ssr] (ecmascript)"); // Import fillMissedDays
...
function WorkoutTracker() {
        ...
        const fetchData = async ()=>{
            ...
            if (lastRecordDate) {
                ...
                if (dayAfterLastRecord <= dayBeforeToday) {
                    ...
                    const filledMissed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$fillMissedDays$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fillMissedDays"])(lastRecordDate, today); // Pass normalized dates
                    if (filledMissed) {
                        console.log("Missed days were filled. Reloading data...");
                        loadedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$loadWorkoutData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadWorkoutData"])(); // Reload to include filled data
                        if (loadedData && Object.keys(loadedData).length > 0) {
    ...
    const handleManualSave = async ()=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$saveWorkoutData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveWorkoutData"])(dateToSaveString, dayToSave, dayRepsToSave);
        setIsSaving(false);
        if (result.success) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8c1af881._.js.map