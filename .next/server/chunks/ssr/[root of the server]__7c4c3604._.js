    ...
    const renderSingleExercise = (ex, indexSuffix = '', roundIndexOffset = 0)=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("grid gap-3", rounds <= 2 ? 'grid-cols-1 sm:grid-cols-2' : '', rounds === 3 ? 'grid-cols-1 sm:grid-cols-3' : '', rounds >= 4 ? 'grid-cols-2 sm:grid-cols-4' : ''),
                    children: [
...
"[project]/src/app/actions/saveWorkoutData.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/actions/loadWorkoutData.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$saveWorkoutData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions/saveWorkoutData.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$loadWorkoutData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions/loadWorkoutData.ts [app-ssr] (ecmascript)");
...
function generateZeroRepsForDay(dayPlan) {
    const zeroDayReps = {
        morningGym: {},
        eveningHome: {}
    };
...
function generateSampleRepsForDay(dayPlan) {
    const sampleDayReps = {
        morningGym: {},
        eveningHome: {}
    };
    ...
    const processWorkoutItems = (items, workoutType)=>{
        ...
        Object.entries(items).forEach(([baseIdentifier, item])=>{
            ...
            if ('exercises' in item) {
                ...
                const suggested = parseSuggestedReps(item.reps);
...
async function seedInitialDataIfNeeded(today) {
    console.log("Checking if initial data seeding is needed...");
    const loadedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$loadWorkoutData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadWorkoutData"])();
    ...
    const prevMondayDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subDays$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subDays"])(today, daysSinceMonday);
    daysToSeed.push({
        dayOfWeek: 'Monday',
        date: prevMondayDate
    });
    ...
    if (daysSinceMonday > 0) {
        const prevTuesdayDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDays"])(prevMondayDate, 1);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInDays$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["differenceInDays"])(today, prevTuesdayDate) >= 0) {
            daysToSeed.push({
                dayOfWeek: 'Tuesday',
                date: prevTuesdayDate
            });
        }
    }
    ...
    for (const { dayOfWeek, date } of daysToSeed){
        const dayPlan = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workout$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["workoutPlan"][dayOfWeek];
        const sampleReps = generateSampleRepsForDay(dayPlan);
        console.log(`Seeding sample data for ${dayOfWeek} (${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(date, 'yyyy-MM-dd')})`);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$saveWorkoutData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveWorkoutData"])(date, dayOfWeek, sampleReps);
    }
...
function WorkoutTracker() {
    ...
    const [lastSavedTimes, setLastSavedTimes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const getDateForDayOfWeek = (targetDayOfWeek, today = new Date())=>{
        const todayDayIndex = ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDay"])(today) + 6) % 7; // 0 = Monday
        const targetDayIndex = daysOfWeek.indexOf(targetDayOfWeek);
        const difference = targetDayIndex - todayDayIndex;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDays"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startOfDay"])(today), difference);
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            ...
            const todayDayIndex = ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDay"])(today) + 6) % 7;
            ...
            let loadedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$loadWorkoutData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadWorkoutData"])();
            if (dataWasSeeded && !loadedData) {
                // Small delay and retry load if seeding happened but load was empty initially
                await new Promise((resolve)=>setTimeout(resolve, 500));
                loadedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$loadWorkoutData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadWorkoutData"])();
            }
            const initialReps = {};
            ...
            if (loadedData && Object.keys(loadedData).length > 0) {
                ...
                if (sortedDates.length > 0) {
                    lastRecordDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseISO"])(sortedDates[0]);
                }
            }
    ...
    const debouncedSave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        saveTimeoutRef.current = setTimeout(async ()=>{
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$saveWorkoutData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveWorkoutData"])(dateToSave, dayToSave, dayRepsToSave);
            setIsSaving(false);
            if (result.success) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "container mx-auto px-2 sm:px-4 py-8 max-w-4xl",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                ...
                children: [
                    ...
                    currentDayLastSavedTime && !currentDayHasUnsavedChanges && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-xs text-muted-foreground text-center absolute bottom-0 left-0 right-0 -mb-4",
                        children: [
                            activeTab,
                            " last saved: ",
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(currentDayLastSavedTime, 'Pp')
                        ]
                    }, void 0, true, {
                        fileName: "[project]/src/components/workout-tracker.tsx",
                        lineNumber: 470,
                    ...
                    currentDayHasUnsavedChanges && !isSaving && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-xs text-orange-500 text-center absolute bottom-0 left-0 right-0 -mb-4",
                        children: [
                            "Unsaved changes for ",
                            activeTab
                        ]
                    ...
                    isSaving && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-xs text-blue-500 text-center absolute bottom-0 left-0 right-0 -mb-4",
                        children: [
                            "Saving ",
                            activeTab,
                            "..."
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tabs"], {
                ...
                children: [
                    isMobile ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        className: "grid w-full grid-cols-3 sm:grid-cols-4 md:grid-cols-7 gap-1 sm:gap-2 mb-6 h-auto flex-wrap justify-center",
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7c4c3604._.js.map