(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_746a7f78._.js", {
    ...
    const renderSingleExercise = (ex, indexSuffix = '', roundIndexOffset = 0)=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("grid gap-3", rounds <= 2 ? 'grid-cols-1 sm:grid-cols-2' : '', rounds === 3 ? 'grid-cols-1 sm:grid-cols-3' : '', rounds >= 4 ? 'grid-cols-2 sm:grid-cols-4' : ''),
                    children: [
...
async function seedInitialDataIfNeeded(today) {
    ...
    const loadedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$loadWorkoutData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadWorkoutData"])();
    ...
    const prevMondayDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subDays"])(today, daysSinceMonday);
    daysToSeed.push({
        dayOfWeek: 'Monday',
        date: prevMondayDate
    });
    ...
    if (daysSinceMonday > 0) {
        const prevTuesdayDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(prevMondayDate, 1);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInDays"])(today, prevTuesdayDate) >= 0) {
            daysToSeed.push({
                dayOfWeek: 'Tuesday',
    ...
    for (const { dayOfWeek, date } of daysToSeed){
        const dayPlan = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workout$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["workoutPlan"][dayOfWeek];
        const sampleReps = generateSampleRepsForDay(dayPlan);
        console.log(`Seeding sample data for ${dayOfWeek} (${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(date, 'yyyy-MM-dd')})`);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$saveWorkoutData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveWorkoutData"])(date, dayOfWeek, sampleReps);
    }
...
function WorkoutTracker() {
    ...
    const [lastSavedTimes, setLastSavedTimes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const getDateForDayOfWeek = (targetDayOfWeek, today = new Date())=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(today), difference);
    };
        ...
        "WorkoutTracker.useEffect": ()=>{
            const fetchData = {
                "WorkoutTracker.useEffect.fetchData": async ()=>{
                    ...
                    const todayDayIndex = ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDay"])(today) + 6) % 7;
                    ...
                    if (dataWasSeeded && !loadedData) {
                        ...
                        await new Promise({
                            "WorkoutTracker.useEffect.fetchData": (resolve)=>setTimeout(resolve, 500)
                        }["WorkoutTracker.useEffect.fetchData"]);
                        loadedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$loadWorkoutData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadWorkoutData"])();
                    }
                    const initialReps = {};
                    ...
                    if (loadedData && Object.keys(loadedData).length > 0) {
                        ...
                        if (sortedDates.length > 0) {
                            lastRecordDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(sortedDates[0]);
                        }
                    }
                    ...
                    daysOfWeek.forEach({
                        "WorkoutTracker.useEffect.fetchData": (day, index)=>{
    ...
    }["WorkoutTracker.useEffect"], []); // Empty dependency array ensures this runs only once on mount
    ...
    const debouncedSave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WorkoutTracker.useCallback[debouncedSave]": ()=>{
            if (saveTimeoutRef.current) {
                clearTimeout(saveTimeoutRef.current);
            }
            saveTimeoutRef.current = setTimeout({
                "WorkoutTracker.useCallback[debouncedSave]": async ()=>{
                    ...
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$saveWorkoutData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveWorkoutData"])(dateToSave, dayToSave, dayRepsToSave);
                    setIsSaving(false);
                    if (result.success) {
                        setLastSavedTimes({
                            "WorkoutTracker.useCallback[debouncedSave]": (prev)=>({
                                    ...prev,
                                    [dayToSave]: new Date()
                                })
                        }["WorkoutTracker.useCallback[debouncedSave]"]);
                        ...
                        }["WorkoutTracker.useCallback[debouncedSave]"]); // Mark data as loaded/saved for this date
                    } else {
                        toast({
            ...
            }["WorkoutTracker.useCallback[debouncedSave]"], 1500); // 1.5-second debounce timer
        }
    }["WorkoutTracker.useCallback[debouncedSave]"], [
        activeTab,
        reps,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                ...
                children: [
                    ...
                    currentDayLastSavedTime && !currentDayHasUnsavedChanges && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-xs text-muted-foreground text-center absolute bottom-0 left-0 right-0 -mb-4",
                        children: [
                            activeTab,
                            " last saved: ",
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(currentDayLastSavedTime, 'Pp')
                        ]
                    }, void 0, true, {
                        fileName: "[project]/src/components/workout-tracker.tsx",
                        lineNumber: 470,
                    ...
                    currentDayHasUnsavedChanges && !isSaving && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    isSaving && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(WorkoutTracker, "m0SMyM6rf8KlkyqumeB4ByInaw0=", false, function() {
    return [
...
//# sourceMappingURL=src_746a7f78._.js.map